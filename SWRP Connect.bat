...
if exist "%USERPROFILE%\Desktop\FiveM SWRP.lnk" (
  cls
...
echo This script will create a desktop shortcut named "FiveM SWRP" that opens the FiveM application
echo and connects to the SosaWorldRP server automatically. No other files will be modified created or deleted.
echo.
...
set shortcutPath=%USERPROFILE%\Desktop\FiveM SWRP.lnk
set targetArgument=fivem://connect/sosaworldrp.com
...
cls
echo The shortcut was created on your desktop. It is named "FiveM SWRP" and will open the FiveM application and connect you to nodus after a few seconds.
echo.
